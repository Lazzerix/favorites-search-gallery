...
import { togglePoolItemsOptions } from "../pool_items_menu_event_handlers";
          ...
          <div class="search-bar-container light-green-gradient">
              <div class="search-bar-items">
                  ...
                  <div class="search-bar-input-container">
                      <input type="text" id="${id}" class="search-bar-input" needs-autocomplete placeholder="Search PoolItems">
                  </div>
