...
export function createPostFromRawFavorite(object: HTMLElement | PoolItemsDatabaseRecord): Post {
  if (object instanceof HTMLElement) {
    return createPostFromPoolItemsPageThumb(object);
  }
...
function createPostFromDatabaseRecord(record: PoolItemsDatabaseRecord): Post {
...
function createPostFromPoolItemsPageThumb(element: HTMLElement): Post {
  const post = createEmptyPost();
