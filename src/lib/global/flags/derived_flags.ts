import {ON_DESKTOP_DEVICE, ON_FAVORITES_PAGE, ON_POOL_ITEMS_PAGE, ON_SEARCH_PAGE} from "./intrinsic_flags";
import { PerformanceProfile } from "../../../types/common_types";
import { Preferences } from "../preferences/preferences";

export const FAVORITES_SEARCH_GALLERY_ENABLED = ON_FAVORITES_PAGE || (ON_SEARCH_PAGE && Preferences.searchPagesEnabled.value) || ON_POOL_ITEMS_PAGE;
export const FAVORITES_SEARCH_GALLERY_DISABLED = !FAVORITES_SEARCH_GALLERY_ENABLED;

export const GALLERY_ENABLED = (ON_FAVORITES_PAGE || ON_SEARCH_PAGE || ON_POOL_ITEMS_PAGE) && (Preferences.performanceProfile.value === PerformanceProfile.NORMAL || Preferences.performanceProfile.value === PerformanceProfile.MEDIUM);
export const GALLERY_DISABLED = !GALLERY_ENABLED;

export const TOOLTIP_ENABLED = (ON_FAVORITES_PAGE || ON_SEARCH_PAGE || ON_POOL_ITEMS_PAGE) && ON_DESKTOP_DEVICE && Preferences.performanceProfile.value !== PerformanceProfile.POTATO;
...
export const AWESOMPLETE_ENABLED = ON_FAVORITES_PAGE || ON_POOL_ITEMS_PAGE;
